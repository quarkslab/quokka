...
//   struc_t* ida_struct =
//       get_struc(std::visit([](const auto& t) { return t.id; },
//       composite_type));
...
//               offset, ConvertIdaString(get_member_name(ida_member->id)),
//               type, size);
//         },
//         composite_type);
...
//         ConvertIdaString(get_struc_name(ida_struct->id)), ida_struct->id,
//         size);
//   else
...
//   // composite types. We need to do it in this order or we won't be able to
//   have
...
//        ++ida_enum_idx) {
//     auto& enum_type =
//         enums.emplace_back(ConvertIdaString(get_enum_name(ida_enum)),
//         ida_enum);
