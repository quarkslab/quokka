...
//   /* FIXME(dm): For some architecture, namely arm64, instructions are
//   serialized
//    * but the reference is wrongly attached to the deduplicated instruction.
//    Due
...
//     Location location, const BucketNew<Instruction>& instructions, ea_t
//     max_ea, const Structures& structures, const FuncChunkCollection& chunks,
//     const BucketNew<Data>& data_bucket) {
...
//                            ref.destination_, instructions, max_ea,
//                            structures, chunks, data_bucket);
...
//                        /* Check if the reference already exists by its hash
//                        and
...
//         // Sometimes, IDA misses the points with references towards non-head
//         so
//         // double check
