...
# THIS FILE ORIGINATES FROM google/binexport AND CAN BE FOUND
# https://raw.githubusercontent.com/google/binexport/11e8e699f43830c7cb3c391740bdbcc0f6514142/cmake/FindIdaSdk.cmake
...
function(ida_add_dependencies name)
    add_dependencies(ida32 ida32_universal)
...
function(ida_target_sources name)
  foreach(target ${name}${_so} ${name}${_so64}
                 ${name}_ea32 ${name}_ea64)
    if(TARGET ${target})
